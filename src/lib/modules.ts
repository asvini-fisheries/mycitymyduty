...
export const LEGACY_MODULE_ALIASES: Record<string, ModuleKey[]> = {
  ...
  projects: [
    ...
    MODULE_KEYS.project_participations,
  ],
  activities: [
...
export const APP_MODULE_OPTIONS: { value: ModuleKey; label: string }[] = [
  ...
  { value: MODULE_KEYS.project_participations, label: "Project Participants" },
...
export const HREF_MODULE_MAP: { href: string; moduleKey: ModuleKey }[] = [
  ...
  { href: "/dashboard/operations/project-participants", moduleKey: MODULE_KEYS.project_participations },
...
export const TABLE_MODULE_MAP: Record<string, ModuleKey> = {
  ...
  project_member_participations: MODULE_KEYS.project_participations,
